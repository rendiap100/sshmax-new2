...
# Install paket resmi OpenVPN & EasyRSA
apt update -y
apt install -y openvpn easy-rsa

# Buat direktori untuk EasyRSA
...
clear
print_install "Menginstall & Mengaktifkan Iptables"

apt update -y
apt install -y iptables iptables-persistent netfilter-persistent

# Simpan aturan default kosong
iptables -F
...
print_success "Iptables"
}

clear
function ins_rclocal(){
clear
print_install "Mengaktifkan rc.local"

# Buat service rc-local kalau belum ada
...
function ins_autoreboot(){
clear
print_install "Mengaktifkan Autoreboot Harian"
...
# Tambahkan jadwal reboot jam 3 pagi
